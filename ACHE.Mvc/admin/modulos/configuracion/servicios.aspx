<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeBehind="servicios.aspx.cs" Inherits="ACHE.Mvc.admin.modulos.configuracion.servicios" %>

<asp:Content ID="Content1" ContentPlaceHolderID="TitleContent" runat="Server">
    Admin :: Servicios
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <script src="/admin/js/views/modulos/configuracion/servicios.js"></script>
</asp:Content>
        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    <i class="fa fa-tags"></i> Administración de servicios
                </header>
                <div class="panel-body">
                    <form id="Form1" runat="server" class="form-inline" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn btn-warning" id="btnNuevo" onclick="nuevo(); return false;">Agregar servicio</button>
                        </div>
                        <br /><br />
                        <div id="grid"></div>    
                    </form>
