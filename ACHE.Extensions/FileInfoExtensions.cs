...
namespace ACHE.Extensions
{
    ...
    public static class FileInfoExtensions
    {
        ...
        public static void Delete(this FileInfo[] files, bool consolidateExceptions)
        {
            ...
            {
                throw new Exception("Error while deleting one or several files, see InnerExceptions array for details.");
            }
        }
        ...
        public static FileInfo[] CopyTo(this FileInfo[] files, string targetPath, bool consolidateExceptions)
        {
            ...
            if ((exceptions != null) && (exceptions.Count > 0))
            {
                throw new Exception("Error while copying one or several files, see InnerExceptions array for details.");
            }
        ...
        public static FileInfo[] MoveTo(this FileInfo[] files, string targetPath, bool consolidateExceptions)
        {
            ...
            if ((exceptions != null) && (exceptions.Count > 0))
            {
                throw new Exception("Error while moving one or several files, see InnerExceptions array for details.");
            }
