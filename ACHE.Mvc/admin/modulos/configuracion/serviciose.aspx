<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeBehind="serviciose.aspx.cs" Inherits="ACHE.Mvc.admin.modulos.configuracion.serviciose" %>
        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    <i class="fa fa-tags"></i> <asp:Literal runat="server" ID="litModo3" /> de Servicio
                </header>
                <div class="panel-body">
                    <form id="Form1" runat="server" class="form-horizontal" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-xs-11">
                                <asp:FileUpload runat="server" ID="flpImagen" />
                                <br />
                                <asp:Image runat="server" ID="imgImagen" Height="200" Visible="false" />
                                <br />
                                <p runat="server" id="pImagen">No hay ninguna imagen cargada</p>
                                <br />
                                <br />
                                <asp:Button runat="server" ID="btnEliminarImagen" Visible="false" CssClass="btn btn-default" OnClick="btnEliminarImagen_Click" Text="Eliminar Imagen" />
                            </div>
                        </div>
                        <div class="form-group">
