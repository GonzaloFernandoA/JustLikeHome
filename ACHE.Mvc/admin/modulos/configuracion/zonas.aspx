<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Admin.master" AutoEventWireup="true" CodeBehind="zonas.aspx.cs" Inherits="ACHE.Mvc.admin.modulos.configuracion.zonas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="HeaderContent" runat="Server">
    <script src="/admin/js/views/modulos/configuracion/zonas.js"></script>
</asp:Content>
        ...
        <div class="col-lg-12">
            <section class="panel">
                <header class="panel-heading">
                    <i class="fa fa-map-marker"></i> Administración de zonas
                </header>
                <div class="panel-body">
                    <form id="Form1" runat="server" class="form-inline" role="form">
                        ...
                        <div class="form-group">
                            ...
                            <button class="btn btn-warning" id="btnNuevo" onclick="nuevo(); return false;">Agregar zona</button>
                        </div>
                        <br /><br />
                        <div id="grid"></div>
                    </form>
